...
namespace TheGame
{
    ...
    public struct Frame
    {
        public Frame(Engine_Picture picture, int delay)
        {
            m_Picture = picture;
            m_Delay = delay;
        }
        public Engine_Picture Picture
        {
            get
            {
                return m_Picture;
        ...
        Engine_Picture m_Picture;
        int m_Delay;

        #endregion
    }

    public class Engine_Animation: ICloneable
    {
        public Engine_Animation()
        {
                        
        }

        protected Engine_Animation(Engine_Animation animation)
        {
        ...
        public int CurrentFrameIndex
     {
        ...
        public Engine_Picture CurrentPicture
        {
            get
            {
        ...
        {
            return new Engine_Animation(this);
        }
