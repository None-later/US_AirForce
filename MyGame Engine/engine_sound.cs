...
namespace TheGame
{
    public class Engine_Sound: IDisposable
    {
        public Engine_Sound(string fileName)
        {
            BufferDescription desc = new BufferDescription();
            desc.StaticBuffer = true;
            m_SecondaryBuffer = new SecondaryBuffer(Engine_Game.SoundPath + fileName, desc, Engine_Game.DSDevice);
        }
